...
# Keras 모델 로드
prediction_model = keras.models.load_model("data.h5", compile=False)
print("Keras 모델 로딩 완료")
...
while (True):
    ...
    # Dataset 생성
    dataset = tf.data.Dataset.from_tensor_slices([f"{filename}"])
    dataset = (
